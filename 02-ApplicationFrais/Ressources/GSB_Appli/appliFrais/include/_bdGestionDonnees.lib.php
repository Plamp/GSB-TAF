...
function obtenirDetailVisiteur($idCnx, $unId) {
	...
	$requete = "select id, nom, prenom,typeMembre from Visiteur where id='" . $unId . "'";
...
function obtenirReqEltsForfaitFicheFrais($unMois, $unIdVisiteur) {
	$unMois = filtrerChainePourBD($unMois);
	$requete = "select idFraisForfait, libelle, quantite,mois from LigneFraisForfait
...
function obtenirReqEltsHorsForfaitFicheFrais($unMois, $unIdVisiteur) {
	$unMois = filtrerChainePourBD($unMois);
	$requete = "select id, date, mois, libelle, montant from LigneFraisHorsForfait
...
function verifierInfosConnexion($idCnx, $unLogin, $unMdp) {
	...
	$req = "select id, nom, prenom, login, mdp, typeMembre from Visiteur where login='".$unLogin."' and mdp='" . $unMdp . "'";
