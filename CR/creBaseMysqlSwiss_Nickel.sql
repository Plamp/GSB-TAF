...
drop database if exists db_gestionCR;
create database db_gestionCR;
use db_gestionCR;
...
CREATE TABLE MOTIF
 (
  MOTIF_ID     varchar (6)  primary key , 
  MOTIF_LIB      varchar (30)
)engine="innodb";
...
CREATE TABLE PRESENTATION
 (
  ...
  Primary key(PRE_CODE,MED_DEPOTLEGAL,RAP_CODE),
